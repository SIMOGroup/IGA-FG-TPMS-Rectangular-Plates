...
% And plot the control net
    for ii = 1:size (nurbs.coefs, 2)
      ...
      plot3 (coefs(1,:)./weights, coefs(2,:)./weights, coefs(3,:)./weights)
      plot3 (coefs(1,:)./weights, coefs(2,:)./weights, coefs(3,:)./weights,'r.','MarkerSize',12)
    end
...
% And plot the control polygon
  ...
  plot3 (coefs(1,:)./weights, coefs(2,:)./weights, coefs(3,:)./weights,'b')
  plot3 (coefs(1,:)./weights, coefs(2,:)./weights, coefs(3,:)./weights,'r.','MarkerSize',12)
end
